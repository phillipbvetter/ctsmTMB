...
testthat::test_that("simulate runs without error using C++ (ekf)", {
  testthat::expect_no_error(
    model$simulate(df, method = "ekf", use.cpp = TRUE, silent = TRUE)
  )
})

testthat::test_that("simulate runs without error using C++ (lkf)", {
  testthat::expect_no_error(
    model$simulate(df, method = "lkf", use.cpp = TRUE, silent = TRUE)
  )
})

testthat::test_that("simulate runs without error using C++ (ukf)", {
  testthat::expect_no_error(
    model$simulate(df, method = "ukf", use.cpp = TRUE, silent = TRUE)
  )
})

testthat::test_that("simulate runs without error using R (ekf)", {
  testthat::expect_no_error(
    model$simulate(df, method = "ekf", use.cpp = FALSE, silent = TRUE)
  )
})

testthat::test_that("simulate runs without error using R (lkf)", {
  testthat::expect_no_error(
    model$simulate(df, method = "lkf", use.cpp = FALSE, silent = TRUE)
  )
})

testthat::test_that("simulate runs without error using R (ukf)", {
  testthat::expect_no_error(
...
testthat::test_that("simulate (2D) runs without error using C++ (ekf)", {
  testthat::expect_no_error(
    model2$simulate(df2, method = "ekf", use.cpp = TRUE, silent = TRUE)
  )
})

testthat::test_that("simulate (2D) runs without error using C++ (lkf)", {
  testthat::expect_no_error(
    model2$simulate(df2, method = "lkf", use.cpp = TRUE, silent = TRUE)
  )
})

testthat::test_that("simulate (2D) runs without error using C++ (ukf)", {
  testthat::expect_no_error(
    model2$simulate(df2, method = "ukf", use.cpp = TRUE, silent = TRUE)
  )
})

testthat::test_that("simulate (2D) runs without error using R (ekf)", {
  testthat::expect_no_error(
    model2$simulate(df2, method = "ekf", use.cpp = FALSE, silent = TRUE)
  )
})

testthat::test_that("simulate (2D) runs without error using R (lkf)", {
  testthat::expect_no_error(
    model2$simulate(df2, method = "lkf", use.cpp = FALSE, silent = TRUE)
  )
})

testthat::test_that("simulate (2D) runs without error using R (ukf)", {
  testthat::expect_no_error(
    model2$simulate(df2, method = "ukf", use.cpp = FALSE, silent = TRUE)
  )
})
