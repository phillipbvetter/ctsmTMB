...
```{r, include=FALSE}
temporary_directory <- normalizePath(file.path(getwd()))
# temporary_directory <- normalizePath(file.path(tempdir(),"ctsmTMBcppfiles"))
# temporary_directory <- normalizePath(file.path(getwd(),"ctsmTMB_cppfiles"))
