...
```{r}
obj$setModelname("GettingStarted")
```

By default the files are stored in the current working directory in a directory called *ctsmTMB_cppfiles*. Another file path can be specified using
