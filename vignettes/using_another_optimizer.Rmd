---
title: "Using another Optimizer"
author: ""
date: ""
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Using another Optimizer}
...
In this document we show how to use the `constructNegLogLike` method to obtain function handlers for the objective function, and gradient, (and hessian if there are no random efects in your model formulation). These handlers can then be parsed to an optimization algorithm of your own choice.
...
```{r, include=FALSE}
tmpdir <- tempdir()
folder_path = paste0(tmpdir,"/ctsmTMB_cppfiles")
obj$setCppfilesDirectory(folder_path)
```
