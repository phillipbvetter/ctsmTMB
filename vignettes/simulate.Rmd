...
A *k*-step **simulation** is a sample of the stochastic path of the model stochatic differential equation *k* time-steps into the future, conditioned on the current state estimate with mean and covariance
$$
